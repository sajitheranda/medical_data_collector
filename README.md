...
- **Firestore as a NoSQL Database**: 
  - Utilizes Firebase Firestore to securely store and manage patient data.
  - Provides real-time access and synchronization across devices to keep information current.

- **Offline Support & Data Synchronization**: 
  - Enables offline data entry, modification, and deletion.
  - Synchronizes all offline changes with Firestore once internet connectivity is restored, ensuring data consistency without data loss.

- **User Authentication & Access Control**: 
  - Uses Firebase Authentication for secure login, limiting access to authorized users only.
  - Protects sensitive data by managing credentials securely and preventing unauthorized access.

- **Soft-Delete for Data Deletion**: 
  - Implements a soft-delete function where deleted data is hidden from view but remains stored securely.
  - Enhances data protection by reducing risks associated with accidental deletion and mitigating potential security threats.
